    ...
    <section>
        <div class="container-fluid  mb-0 px-5 d-sm-flex" id="hero">
            <div class="content textContent text-center align-self-center col-md-7">
                ...
                <div class="button justify-content-center mb-2  gap-4 d-sm-flex">
                    <div>
                        <a class="btn getStarted mb-3" href="./register/">Get started now</a>
                    </div>
    ...
    <section id="pricing">
        <div class="container my-3">
            ...
            <div class="gap-3 d-md-flex">
                <div class="text-center mtn px-3 col-md-3 cardcontainer">
                ...
                <div class="text-center mtn px-3 col-md-3 cardcontainer">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>GLO Gifting 1.9GB</td>
                                <td><?= $g2 ?></td>
                            </tr>
                            <tr>
                                <td>GLO Gifting 3.5GB</td>
                                <td><?= $g3 ?></td>
                            </tr>
                            <tr>
                                <td>GLO Gifting 5.2GB</td>
                                <td><?= $g4 ?></td>
                            </tr>
                            <tr>
                                <td>GLO Gifting 6.8GB</td>
                                <td><?= $g5 ?></td>
                            </tr>
                            <tr>
                                <td>GLO Gifting 9.0GB</td>
                                <td><?= $g6 ?></td>
                            </tr>
                        </tbody>
                    </table>
