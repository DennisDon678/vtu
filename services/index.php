                            ...
                            <form action="../app/services/Data.php" method="post">
                                ...
                                <div class="form-outline flex-fill mb-1">
                                    <select name="plan" id="glo1" class="form-select">
                                        ...
                                        <option value="195">2.9GB GIFTING Data - NGN <?= $g2 ?></option>
                                        <option value="196">4.1GB GIFTING Data - NGN <?= $g3 ?></option>
                                        <option value="197">5.8GB GIFTING Data - NGN <?= $g4 ?></option>
                                        <option value="198">7.7GB GIFTING Data - NGN <?= $g5 ?></option>
                                        <option value="199">10GB GIFTING Data - NGN <?= $g6 ?></option>
                                    </select>
                                    <label class="form-label" for="plan">Select Plan</label>
                                </div>
                                <div class="form-outline flex-fill mb-1">
